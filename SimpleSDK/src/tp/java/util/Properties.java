...
/**
 * An simple implementation much like java.util.Properties in Java SE.
 * It enables reading an {@link InputStream} with key=value pairs (one per line).
...
public class Properties {
    ...
    private void processLine(String line) {
        ...
        String value = equalsIndex + 1 < line.length() ? line.substring(equalsIndex + 1).trim() : "";
    ...
    public void setProperty(String key, String value) {
        ...
        public void put(String key, Runnable value) {
            setProperty(key, value.toString());
    }

        public void put(String key, Hashtable value) {
            setProperty(key, value.toString());
    }
     ...
     * @param key
     * @param defaultValue
     * @return the value for key or the default value.
     */
