...
//                      logger = getLogger(loggerClassName, ResourceBundle.getBundle(messageCatalogName), loggerID, null) ;
                ...
                } catch (Exception e) {System.out.println("LoggerFactory.java getLogger() " + e.toString());}
...
//			throw new MissingResourceException("Error locating the logging class", CLASS_NAME, loggerID);
	 ...
	 */
	private static Logger getLogger(String loggerClassName, PropertyResourceBundle messageCatalog, String loggerID, String resourceName) {
		Logger logger  = null;
		Class logClass = null;
