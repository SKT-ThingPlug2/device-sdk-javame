...
public class SSLMicroNetworkModule implements NetworkModule {
     ...
     */
    public SSLMicroNetworkModule(String host, int port, int keepAlive) {
        this.uriForSocket  = "socket://" + host + ":" + port;
    ...
    public void start() throws IOException, MqttException {
        ...
        try {
            ...
            tlsClientProtocol = new TlsClientProtocol(connection.openInputStream(), connection.openOutputStream(), new SecureRandom());
...
//                            throw new IOException("Not supported yet.");
            ...
            in = tlsClientProtocol.getInputStream();
            out = tlsClientProtocol.getOutputStream();
